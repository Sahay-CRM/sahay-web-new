    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "absolute left-1 size-7 bg-transparent p-0 opacity-50 hover:opacity-100 disabled:invisible",
        ),
        button_next: cn(
          buttonVariants({ variant: "outline" }),
          "absolute right-1 size-7 bg-transparent p-0 opacity-50 hover:opacity-100 disabled:invisible",
        ),
