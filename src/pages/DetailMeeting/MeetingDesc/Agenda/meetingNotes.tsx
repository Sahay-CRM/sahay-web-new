...
const MeetingNotes: React.FC<MeetingNotesProps> = ({
  ...
  return (
    <div>
      {isTopBarShow && (
        <div className="h-[50px] flex items-center justify-between py-3 border-b  mb-3">
          {isSearching ? (
            ...
            <h3 className="p-0 text-base pl-0">{title}</h3>
          )}
      ...
      <div className={cn("px-2", className)}>
        {meetingStatus !== "ENDED" && FilterBy !== "noteTag" && (
          <div className="bg-white rounded-lg py-2 px-2 border shadow-sm relative">
            <textarea
              className="w-full border text-black px-2 py-2 pr-1 text-sm shadow-none focus:border-0 focus-visible:ring-0 focus:ring-0 focus-visible:ring-offset-0 bg-transparent"
                            ...
                            {editingNoteId === note.meetingNoteId ? (
                              <div className="flex-1">
                                <textarea
                                  ...
                                  rows={
                                    expandedNotes[note.meetingNoteId] ? 5 : 2
                                  }
                                  autoFocus
                                />
