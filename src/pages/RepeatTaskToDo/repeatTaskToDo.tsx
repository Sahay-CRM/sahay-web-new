              ...
              <div className="flex-1 overflow-hidden flex flex-col mb-4">
                ...
                <div className="flex-1 overflow-y-auto pr-2">
                  {activeTasks.map((task) => (
                    <div
                      key={task.taskId}
                      className={`group overflow-hidden flex h-12 justify-between px-2 rounded-sm border bg-card hover:bg-accent transition mb-2 ${selectedDate !== today && "bg-gray-300 hover:bg-gray-200"}`}
                    >
              ...
              <div className="flex-1 overflow-hidden flex flex-col border-t pt-4">
                ...
                <div className="flex-1 overflow-y-auto pr-2">
                  {doneTasks.map((task) => (
                    <div
                      key={task.taskId}
                      className={`flex h-12 justify-between border p-2 rounded-md bg-gray-100 hover:bg-gray-200 transition items-center mb-2 ${selectedDate === today ? "" : "bg-gray-200"}`}
                    >
