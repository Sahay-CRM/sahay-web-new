...
export default function Graph() {
  ...
  useEffect(() => {
    ...
    individualResult.forEach((core, idx) => {
      let start = 0;
    ...
    <div className="flex flex-col items-center gap-10">
      ...
      <Card className="w-full h-auto items-center justify-center p-12 rounded-xl">
        <CardContent className="flex flex-col items-center justify-center">
          <div className="mb-2 text-xl font-semibold text-primary">Company</div>
          <ChartContainer
            config={chartConfig}
          ...
          >
            ...
            >
              ...
              <g filter="url(#needleShadow)">
                ...
                />
                <text
                  x={companyNeedle.x - 20}
                  y={companyNeedle.y - 15}
                  fontSize="19"
                >
                  {animatedCompany}%
                </text>
                ...
                <div key={core.coreParameterId} className="w-[380px]">
                  ...
                  >
                    <RadialBarChart
                      ...
                      cx={cx}
                      cy={cy}
                      data={coreChartData[idx] || [{ name: "Usage", value: 0 }]}
                    >
                      <defs>
                        <linearGradient
                          id="usageGradient2"
