...
export default function MeetingDrawer({
  ...
  return (
    <>
      {open && <div className="fixed inset-0 bg-black/60 z-50 transition-opacity" />}
      <div
        ref={drawerRef}
        className={`fixed top-0 right-0 h-full w-full max-w-md bg-white shadow-lg z-50 transform transition-transform duration-300 ease-in-out flex flex-col
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex-1 flex flex-col overflow-hidden">
          <div className="flex-1 overflow-y-auto p-5 space-y-5">
            <div className="relative z-50" ref={dropdownRef}>
              ...
              />
              {showResults && (
                <div className="absolute top-[100%] left-0 mt-1 w-full bg-white border border-gray-200 rounded-md shadow-lg max-h-60 overflow-y-auto z-[999]">
